...
public class JdbcClient {
	 ...
	 */
	public static SqlResult execute(String url, String username, char[] password, String sqlQuery, boolean showWarnings,
		...
		try (Connection databaseConnection = (username == null || password == null) ? DriverManager.getConnection(url)
